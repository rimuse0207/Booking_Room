...
const RouterPage = () => {
  ...
  const TokenCheckFromServer = async () => {
    try {
      const TokenCheckFromServerVerify = await request.post(
      ...
      <CookiesProvider>
        <BrowserRouter>
          <Switch>
            ...
            <Route
              exact
              path="/User_Select_or_Add/:UserId/:UserCompany"
              component={UserManageMainPage}
            ></Route>
            {/* 식단 관련 */}
            <Route
              exact
              path="/Today_Food"
              component={TodayFoodContainer}
            ></Route>
            <Route
              path="/Today_Food/SelectWeekFoodCount"
              component={SelectWeekFoodCount}
            ></Route>
            <Route path="/Food_Select" component={FoodSelectMainPage}></Route>
            <Route path="/Food_Survay" component={SurvayContainer}></Route>
            <Route
              path="/Admin_Image_Check"
              component={AdminImageShowMainPage}
            ></Route>
            {/* 조식관련 */}
            <Route
              path="/BreakFast/UserSlect"
              component={UserBreakFastMainPage}
            ></Route>
            <Route
              path="/BreakFast/Finished"
              component={UserApplyFinishedMainPage}
            ></Route>
            <Route
              path="/Admin/BreakFast"
              component={AdminBreakFastMainPage}
            ></Route>
            {/* 탕비실 관련 */}
            ...
            <Route
              exact
              path="/KIZUKI_Notepad"
              component={KizukiNotepadMainPage}
            ></Route>
            <Route
              exact
              path="/KIZUKI_Notepad/:team_code"
              component={KizukiRoomListMainPage}
            ></Route>
            <Route
              path="/KIZUKI_Notepad_List_Select/:team_code/:kizuki_code"
              component={KizukiContentMainPage}
            ></Route>
            <Route
              path="/KIZUKI_Notepad_Write"
              component={KizukiWriteMainPage}
            ></Route>
            {/* PIM 로컬전 */}
            <Route exact path="/PIM" component={PimMainContainer}></Route>
            <Route
              path="/PIM/PIMApplyRoom"
              component={PimRoomApplyMainContainer}
            ></Route>
            <Route
              path="/PIM/RoomEnter/:Room_Keys/:Room_Title"
              component={PimRoomEnterContainer}
            ></Route>
            <Route
              path="/PIM/QRCode/:Room_keys/:Room_Title"
              component={PimQRCodeMaker}
            ></Route>
            {/* 자리배치도 */}
            <Route
              exact
              path="/FloorLayout"
              component={FloorLayoutMainPage}
            ></Route>
            {/* 나의 일정 조회 */}
            <Route exact path="/My_Pims" component={DailyPimsMainPage}></Route>
            <Route
              exact
              path="/SchedulesDashboard"
              component={SchedulesDashboard}
            ></Route>
            <Route
              path="/FloorLayout/AdminChange"
              component={FloorLayoutAdminMinPage}
            ></Route>
            {/* 차량운행 */}
            <Route
              exact
              path="/VehicleOperaion"
              component={VehicleOperationMainPage}
            ></Route>
            <Route
            ...
            ></Route>
            <Route
              path="/VehicleOperaion/NewVehicleOperation"
              component={VehicleOperationSubmitMainPage}
            ></Route>
            {/* 당직근무 */}
            ...
            {/* DHKS 관리자 */}
            <Route
              path="/DHKS_Admin_Access_Control_Page"
              component={AdminResoucesMainPage}
            ></Route>
            <Route
              path="/Admin_Week_Survay_Check"
              component={AdminSurvayMainPage}
            ></Route>
            {/* 기타 */}
            <Route
              path="/Info_Loading/cLCYwLMPxquhcvijjqwoewmqwoi/:id/:date/:company"
              component={SpamTrainingMainPage}
            ></Route>
            <Route
              path="/Users/OrganChart/MainPage/:token/:id/:name"
              component={OrganChartMainPage}
            ></Route>
            <Route
              path="/Defalult_MailSending/:purpose/:period/:person/:time/:count"
              component={MailSendingMainPage}
            ></Route>
            <Route
