                ...
                <div>
                    <div style={{ marginBottom: '50px', lineHeight: '30px' }}>
                        ...
                        <div>
                            <span>추가 식수 (+) : </span>
                            <span>
                                {Now_Basic_Want_Eating_Count.reduce((pre, next) => pre + next.food_count_apply_eat_count, 0) +
                                    Basic_Change_Count.reduce((pre, next) => pre + next.food_count_apply_eat_count, 0) -
                                    Basic_Change_Count.length}{' '}
                                명
                            </span>
                        </div>
                        <div>
