...
const OrganChartMainPage = ({ UserSearchModalOn, setUserSearchModalOn, ClickedUser }) => {
    ...
    const Upper_Department_Select_Getting = async departmentCode => {
        try {
            const Upper_Department_Select_Getting_Axios = await Axios_Get_Moduls('/DepartmentRouter/Upper_Department_Select_Getting', {
                departmentCode,
            });
    ...
    const Select_UserInfoDataGetting = async () => {
        try {
            const Select_UserInfoDataGetting_Axios = await Axios_Get_Moduls(`/DepartmentRouter/Select_UserInfoDataGetting`, {});
    ...
    const OrganDataGetting = async () => {
        try {
            const OrganDataGetting_Axios = await Axios_Get_Moduls(`/DepartmentRouter/DepartMent_Data`, {
                SearchUser,
            });
    ...
    const ChangeSelectedInfoGettingPersonInfo = async () => {
        try {
            const ChangeSelectedInfoGettingPersonInfo_Axios = await Axios_Get_Moduls(
                `/DepartmentRouter/ChangeSelectedInfoGettingPersonInfo`,
                {
                    ClickItemSelected,
                }
            );
                            ...
                            <table>
                                ...
                                <tbody className="table_tbody">
                                    {UserDetailInfo.map(list => {
                                        return (
                                            <tr
                                                key={list.brity_works_detail_user_info_id}
                                                style={
                                                    SelectUserNames === list.brity_works_detail_user_info_id
                                            ...
                                            >
                                                ...
                                                <td>
                                                    <a href={`mailto:${list.brity_works_detail_user_info_id}`}>
                                                        {list.brity_works_detail_user_info_id}
                                                    </a>
                                                </td>
