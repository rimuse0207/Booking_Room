...
const ContentContainer = ({ list,Kizuki_Conent_Add_Modal_Is_Open ,OnClose,setSelect_Kizuki}) => {
    ...
    const Handle_Clicks_Comment_Data = async () => {
        try {
            ...
            const Handle_Clicks_Comment_Data_Axios = await request.post('/LocalPim/Handle_Clicks_Comment_Data', {
                commentTextBox,
                Select_Datas: list,
            ...
            if (Handle_Clicks_Comment_Data_Axios.data.dataSuccess) {
    ...
    const Kizuki_Comment_List_Getting = async () => {
        try {
            ...
            const Kizuki_Comment_List_Getting_Axios = await request.get(`/LocalPim/Kizuki_Comment_List_Getting`, {
                params: {
                    kizuki_key : list.kizuki_notepad_kizuki_content_key
                }
            })
            if (Kizuki_Comment_List_Getting_Axios.data.dataSuccess) {
                setCommentList(Kizuki_Comment_List_Getting_Axios.data.Root_Data)
                setAll_Comment_List(Kizuki_Comment_List_Getting_Axios.data.Root_Data)
            }
    ...
    return (
        <ContentContainerMainDivBox>
            <div className="Main_Content_Container">
                <div className="New_Code_Write" onClick={() => {
                ...
                <div className="Main_Content_Review">
                    ...
                    <div className="Review_Container">
                        <textarea placeholder="댓글 작성" value={commentTextBox} onChange={(e)=>setcommentTextBox(e.target.value)}>
                    ...
                    <CommentMainPage commentList={commentList} setCommentList={(data)=>setCommentList(data)} All_Comment_List={All_Comment_List} setAll_Comment_List={data=>setAll_Comment_List(data)} ></CommentMainPage>
